...
<body>
    <header>
        <a href="index.html" class="logo"><img src="./public/img/logo.svg" alt="" class="logo"></a>
        <nav>
            <ul id="navbar">
                <li><a href="index.html" class="active">Home</a></li>
                <li><a href="./src/Views/shop.html">Shop</a></li>
                <li><a href="./src/Views/blog.html">Blog</a></li>
                <li><a href="./src/Views/about.html">About</a></li>
                <li><a href="./src/Views/contact.html">Contact</a></li>
                <li id="lg-bag"><a href="./src/Views/cart.html"><i class="fa fa-bag-shopping"></i></a></li>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="./public/img/products/f2.jpg" alt="">
                <div class="des">
                    <span>Zara</span>
            ...
            <div class="pro">
                <img src="./public/img/products/f3.jpg" alt="">
                <div class="des">
                    <span>Zara</span>
            ...
            <div class="pro">
                <img src="./public/img/products/f5.jpg" alt="">
                <div class="des">
                    <span>H&M</span>
                    <h5>FLORAL PRINT SHIRT</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="./public/img/products/f8.jpg" alt="">
                <div class="des">
                    <span>Zara</span>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="./public/img/products/n1.jpg" alt="">
                <div class="des">
                    <span>H&M</span>
            ...
            <div class="pro">
                <img src="./public/img/products/n2.jpg" alt="">
                <div class="des">
            ...
            <div class="pro">
                <img src="./public/img/products/n3.jpg" alt="">
                <div class="des">
                    <span>H&M</span>
            ...
            <div class="pro">
                <img src="./public/img/products/n4.jpg" alt="">
                <div class="des">
                    <span>POLO</span>
                    <h5>Polo T-Shirt</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="./public/img/products/n5.jpg" alt="">
                <div class="des">
                    <span>H&M</span>
                    <h5>JEANS SHIRT</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="./public/img/products/n6.jpg" alt="">
                <div class="des">
                    <span>LC WAIKIKI</span>
            ...
            <div class="pro">
                <img src="./public/img/products/n7.jpg" alt="">
                <div class="des">
                    <span>LC WIKIKI</span>
            ...
            <div class="pro">
                <img src="./public/img/products/n8.jpg" alt="">
                <div class="des">
                    <span>H&M</span>
    ...
    <footer class="section-p1">
        <div class="col">
            <img src="./public/img/logo.svg" alt="" class="logo">
            <h4>Contact</h4>
        ...
        <div class="col install">
            <h4>Install src</h4>
            <p>From src Store or Google Play</p>
            <div class="row">
                <img src="./public/img/pay/src.jpg" alt="">
